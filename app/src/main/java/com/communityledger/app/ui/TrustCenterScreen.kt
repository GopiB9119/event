...
private fun AboutContent(viewModel: EventViewModel) {
    ...
    TrustContent {
        ...
        if (BuildConfig.DIRECT_UPDATE_ENABLED) {
            ...
            TrustSection(
                title = "Updates",
                body = "Updates for this build are delivered by Google Play. This app does not check or open a separate APK release channel."
            )
        }

...
object UpdateChecker {
    const val MANIFEST_URL = "https://gopib9119.github.io/event/releases/community-ledger-app.json"
    ...
    fun evaluateManifest(jsonText: String, currentVersionCode: Int): UpdateCheckResult {
        return try {
            ...
            if (manifest.optString("applicationId").trim() != BuildConfig.APPLICATION_ID) {
                return UpdateCheckResult.Failed("Release information belongs to a different app.")
            }
